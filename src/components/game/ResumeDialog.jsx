    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-background/85 backdrop-blur-sm font-game">
      <Card className="w-full max-w-md shadow-2xl border-border/60">
        <CardContent className="p-10 text-center space-y-6">
          {/* Session restored warning — game-badge-text token */}
          {isResuming && (
            <div className="flex justify-center">
              <Badge
                variant="outline"
                className="gap-1.5 border-game-accent/40 text-game-accent bg-game-accent/5 game-badge-text font-game">
          ...
          <div className="space-y-2">
            {/* game-label token for the eyebrow */}
            <p className="game-label text-muted-foreground">
          ...
          {/* Context message — game-body token (text-base leading-relaxed) */}
          <p className="game-body text-muted-foreground">
            {isResuming
